<%-- 
    ...
    Created on : 16 Oct, 2020, 4:41:15 PM
    Author     : hp
--%>
    ...
    <body onload="spinStop()">
        ...
        <div class="card-body">
            <div class="card text-center">
                ...
                <div class="card-body">
                    <h5 class="card-title">Welcome to Covid Health Care System Admin Home !</h5><br/>
                    <a href="addHosp.jsp" class="btn btn-primary">Add Hospital</a>
                </div>
            </div>
        </div>
