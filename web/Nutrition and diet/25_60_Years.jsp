<%-- 
    Document   : 25_60_Years.jsp
    Created on : 4 Dec, 2020, 12:24:20 PM
    Author     : HP
--%>
...
<html>
    ...
    <body onload="spinStop()">
        ...
        <div class="card">
            <div class="card-body">
                <div class="card mb-3">
                    <img class="card-img-top" src="Images/background image 25 to60.jpg" alt="Card image cap">
                    <h5 class="card-title">  25Yr. To 60Yr. Nutrition & Diet</h5>
                    <p class="card-text"></p>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <img class="card-img-top" src="Images/25 to 60yr 2.jpg" alt="Card image cap">
                                                               <p class="card-text"> The immune system requires the support of many nutrients.It is recommended to consume a variety of foods for a healthy and balanced diet, including whole grains, legumes, vegetables, fruits, nuts and animal source foods. There is no single food that will prevent you from catching COVID-19.There is currently no evidence that people can catch COVID-19 from food. The virus that causes COVID-19 can be killed at temperatures similar to that of other known viruses and bacteria found in food. Foods such as meat, poultry and eggs should always be thoroughly cooked to at least 70°C. Before cooking, raw animal products should be handled with care to avoid cross-contamination with cooked foods.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <img class="card-img-top" src="Images/25_60 food plan.jpg" alt="Card image cap">
                            </div>
                        </div>
                    </div>
                </div>
