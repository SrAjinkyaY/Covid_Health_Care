<%-- 
    Document   : userHome
    Created on : 3 Nov, 2020, 1:08:19 AM
    Author     : hp
--%>
...
<html>
    ...
    <body onload="spinStop()">
        ...
        <nav class="navbar navbar-expand-md navbar-light">
            ...
            <a class="navbar-brand mb-2" href="userHome.html">
                <b class="h3">🅲🅾🆅🅸🅳 🅷🅴🅰🅻🆃🅷 🅲🅰🆁🅴</b>
            </a>
        ...
        <div class="card">
                <div class="card-body">
                    <div class="card text-center">
                        <div class="card-body">
                            <h2 class="card-title">Hello <%=rs.getString(2)%> !</h2>
                            <h4><p class="card-text">Welcome To Covid Health Care.</p></h4>
                        </div>
                    </div>
                </div>
            </div>
